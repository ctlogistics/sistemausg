<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $rememberme = $_POST['rememberme'];
        ...
        $return = $auth->login($user, $password, $rememberme, NULL);
...
<head>
	<meta charset="UTF-8">
    	<title>TTS Logistics - Login</title>
...
<body class="easyui-layout">
    <div style=" float: left; position: absolute; left: 0px; top: 0px; z-index: 4"><img src="images/usgLogo_00.jpg" /></div>

	<div data-options="region:'north',border:false" style="height:100px;background:#ffffff;padding:10px">

	</div>
	<div data-options="region:'south',border:false" style="height:50px;background:#ffffff;padding:10px; text-align:center; color:#000000">TTS Logistics todos los derechos reservados 2016   Tel. +52 (55) 1333 1524   E-mail: admon@ttslogistics.com.mx</div>
	...
	<div id="register_form" class="easyui-window" data-options=" shadow:false, border:false, collapsible:false, closable:false, minimizable:false, maximizable:false" title="SISTEMA USG"  style="padding: 50px; background-image:url(images/backOrange.png); background-repeat: no-repeat; -webkit-background-size: cover; -moz-background-size: cover;-o-background-size: cover; background-size: 110%; background-position:center;  width:400px; height:300px; text-align:center ">
            <form id="create" class="form" method="post" action="#" style="text-align: right;">
                <table style="width:100%">
                    ...
                    <tr>
                        <td> Recuerdame :</td>
                        <td style="text-align:left"> <input type="checkbox" name="rememberme" id="rememberme"> </td>
                    </tr>
                    ...
                    <tr>
                        <td> </td>
                        <td> <a href="#" name="login" id="login" class="easyui-linkbutton"  style="width:100px">Entrar</a>
